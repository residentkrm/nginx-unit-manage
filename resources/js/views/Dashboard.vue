        ...
        <div v-else>
            ...
            <div v-if="status" class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                >
                    ...
                    <div class="p-6">
                        <div
                            v-for="(module, name) in status.modules"
                            :key="name"
                        ...
                        >
                            ...
                            <div
                                v-if="Array.isArray(module)"
                                class="ml-4 space-y-2"
                            >
                                <div
                                    v-for="(item, idx) in module"
                                    :key="idx"
                ...
                <div
                    v-if="
                        status.applications &&
                        Object.keys(status.applications).length > 0
                    "
                    class="bg-white dark:bg-gray-800 shadow rounded-lg lg:col-span-2"
                >
                    <div
                        class="px-6 py-4 border-b border-gray-200 dark:border-gray-700"
                    >
