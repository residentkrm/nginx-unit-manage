            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 transition-colors">
                ...
                <div v-show="activeTab === 'form'" class="space-y-6">
                    <div>
                        ...
                        <input v-model="form.address" type="text" id="address" required placeholder="*:8080" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400 sm:text-sm">
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Format: *:8080, 127.0.0.1:80, [::1]:8080, or unix:@abstract_socket</p>
                    </div>
                ...
                <div v-show="activeTab === 'json'" class="space-y-6">
                    <div>
                        <label for="addressJson" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Address</label>
                        <input v-model="form.address" type="text" id="addressJson" required placeholder="*:8080" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400 sm:text-sm">
                    </div>
